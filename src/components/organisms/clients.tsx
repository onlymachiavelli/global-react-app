...
const columns = [
  ...
  { name: "TOTAL ORDERS", uid: "totalorders", sortable: false },
]
      ...
      case "name":
        return (
          <User
            avatarProps={{
              radius: "lg",
              src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnT08Vr-5u0H9C-2zi0vETETLTbAw45AS9oBjviTHppA&s",
              isBordered: true,
            }}
            ...
            <Dropdown backdrop="blur">
              ...
              <DropdownMenu variant="faded" aria-label="Static Actions">
                {business.products.map((product: any) => {
                  return (
                    <DropdownItem key={product.id} className="capitalize">
                      <User
                        name="Junior Garcia"
                        description={product.products.name}
                        classNames={{
