...
export default function App() {
  ...
  const [statusFilter, setStatusFilter]: any = React.useState("all")
  const [rowsPerPage, setRowsPerPage]: any = React.useState(8)
  const [sortDescriptor, setSortDescriptor]: any = React.useState({
    column: "age",
    direction: "ascending",
  })
