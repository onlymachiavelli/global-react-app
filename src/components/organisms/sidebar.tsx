  ...
  return (
    <>
      <aside
        ...
        className="w-2/12 h-screen p-4 overflow-y-auto bg-[#f6f4f5]"
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">
                  <Link href={`/dashboard/business/inventory/${props.ID}`}>
                    Inventory
                  </Link>
                </span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">
                  <Link href={`/dashboard/business/${props.ID}/crm`}>CRM</Link>
                </span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">
                  <Link href={`/dashboard/business/${props.ID}/orders`}>
                    Orders
                  </Link>
                </span>
              </a>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">
                  <Link href="/dashboard/assistant">Customer Assistant</Link>
                </span>
              </a>
            </li>
          </ul>
